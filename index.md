...
## Primary Focus
A video capture (or similar) app that provides at least 80 percent of the information provided by a white cane.
...
1) Extensive tests to determine the base audible feedback plan for a clear path.
